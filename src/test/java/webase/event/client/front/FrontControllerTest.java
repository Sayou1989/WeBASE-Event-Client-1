...
public class FrontControllerTest extends BaseTest {
    ...
    public void testRegisterBlockNotify() throws Exception {
        ...
        param.setQueueName("appId001");
        param.setAppId("appId001");
        param.setGroupId(groupId);
        ResultActions resultActions =
                mockMvc.perform(MockMvcRequestBuilders.post("/front/newBlockEvent")
    ...
    public void testRegisterEventLogPush() throws Exception {
        ...
        param.setExchangeName("exchange_group1");
        param.setQueueName("appId001");
        param.setContractAbi(JSON.parseArray(
        ...
        topics.add("set(string)");
        param.setTopicList(topics);
        ResultActions resultActions =
                mockMvc.perform(MockMvcRequestBuilders.post("/front/contractEvent")
                        .content(JSON.toJSONString(param)).contentType(MediaType.APPLICATION_JSON));
        resultActions.andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
        System.out.println(
